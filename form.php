...
<!DOCTYPE html>
    ...
    <body>
        ...
        <h1 class="TT">Formulario de Denuncia</h1>

        <!-- Formulario dividido por secciones -->
        <form id="formulario" method="POST" enctype="multipart/form-data">

            <!-- Sección 1: Tipo de denuncia -->
            <div class="seccion active sombraII" id="seccion1">
                
                <h2 class="td">Sección 1: Tipo de denuncia</h2>
            ...
            <div class="seccion sombraII" id="seccion2">
